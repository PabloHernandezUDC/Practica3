...
def ask_for_option(max_options: int):
    ...
    ------------
    max_options: int
        Int used to choose an option in the menu.
...
def avg_loans(bl):
    '''
    A functions that calculates the average number of loans of a list of books
...
def remove_duplicates(bl):
    ...
    ------------
    unique_books: list
        The new lidst, with the same books but with the duplicates removed.
    '''
    unique_books = bl
...
def show_books(bl, t):
    '''
    A function that returns the operations that the menu function 4th option offered.
    ...
    t: str
        an str used to select one of the three options of the function.
